...
<template>
  <div>
    ...
    <div
      v-if="caseStudiesData && caseStudiesData.length > 0"
        ...
        <div class="space-y-6">
          ...
          <div v-if="study.challenges && study.challenges.length > 0">
            ...
            <ul class="list-disc list-inside space-y-1">
              <li
                v-for="(challenge, index) in study.challenges.slice(0, 3)"
                :key="index"
              >
                {{ challenge }}
              </li>
          ...
          <div
            v-if="
              ...
              Object.keys(study.businessImpact).length > 0
            "
            class="p-4"
          >
            ...
            <div class="grid grid-cols-2 gap-3">
              <div
                v-for="(value, key) in study.businessImpact"
                :key="key"
                class="text-center"
              >
                <div class="text-lg font-bold">{{ value }}</div>
                <div
                  class="text-[10px] text-neutral-500 dark:text-neutral-400 capitalize"
                >
          ...
          <div v-if="study.outcomes && study.outcomes.length > 0">
            ...
            <ul class="list-disc list-inside space-y-1">
              <li
                v-for="(outcome, index) in study.outcomes.slice(0, 3)"
                :key="index"
              >
                {{ outcome }}
              </li>
          ...
          <div class="pt-4">
            <UButton
              v-if="study.links?.case_study"
              :to="study.links.case_study"
              class="w-full"
            >
