  ...
  <section v-if="profileData" class="py-20">
    <div class="max-w-6xl mx-auto px-4">
      <div class="text-center mb-12">
        ...
        >
          I partner with organizations and founders who need technical expertise
          to build and scale their products
        </p>
      </div>
      ...
      <div
        v-else-if="profileData.whoIWorkWith?.length"
        class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mb-16"
      >
        <UCard
          v-for="audience in profileData.whoIWorkWith"
          :key="audience.name"
      ...
      <div v-else-if="profileData.pricingRanges" class="space-y-8">
        <h3
          class="text-2xl font-bold text-center text-neutral-900 dark:text-white"
        >
          Pricing
        </h3>
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <template #header>
              <div class="text-center">
                ...
                >
                  {{
                    formatPrice(
                      profileData.pricingRanges.mvp.min,
                      profileData.pricingRanges.mvp.max,
                      profileData.pricingRanges.mvp.currency,
                    )
                  }}
                </div>
            ...
            <template #header>
              <div class="text-center">
                ...
                >
                  {{
                    formatPrice(
                      profileData.pricingRanges.architectureAudit.min,
                      profileData.pricingRanges.architectureAudit.max,
                      profileData.pricingRanges.architectureAudit.currency,
                    )
                  }}
                </div>
                <p class="text-sm text-neutral-500 dark:text-neutral-400 mt-2">
            ...
            <template #header>
              <div class="text-center">
                ...
                >
                  {{
                    formatPrice(
                      profileData.pricingRanges.hourly.min,
                      profileData.pricingRanges.hourly.max,
                      profileData.pricingRanges.hourly.currency,
                    )
                  }}
                </div>
                <p class="text-sm text-neutral-500 dark:text-neutral-400 mt-2">
        ...
        <div class="text-center mt-8">
          <p class="text-neutral-600 dark:text-neutral-400 mb-4">
            Pricing varies based on project scope and requirements. Let's
            discuss your needs.
          </p>
