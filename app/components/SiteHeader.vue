  ...
  <header :class="[
    ...
    <div class="relative">
      <div class="flex justify-center items-center px-4 py-1.5">
        <nav class="flex justify-center items-center gap-4 lg:gap-6 w-full text-sm font-medium" role="navigation"
          ...
          <ULink to="/"
            ...
            <UIcon name="i-ph-code" class="w-5 h-5 text-primary-600 dark:text-primary-400" />
          ...
          <div class="flex items-center gap-1">
            <!-- Contact CTA -->
            <UButton to="/contact" variant="solid" color="primary" size="sm"
              class="hidden md:inline-flex rounded-full px-4" label="Contact" />
      ...
      <div v-show="mobileMenuOpen" id="mobile-menu"
        ...
        <div class="m-4" @click="toggleMobileMenu">
          <div
            ...
            <nav class="flex flex-col py-4 px-4 gap-1" aria-label="Mobile navigation">
              ...
              <!-- Mobile Contact CTA -->
              <div class="pt-2 mt-2 border-t border-neutral-200/60 dark:border-neutral-800/60">
                <UButton to="/contact" variant="solid" color="primary" size="md"
                  class="w-full rounded-xl justify-center" label="Contact Me" />
              </div>
            </nav>
          </div>
        </div>
