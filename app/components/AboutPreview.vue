...
<template>
  <section v-if="profileData" class="py-16 md:py-24">
      ...
      <div class="grid gap-6 md:gap-8 sm:grid-cols-2 lg:grid-cols-3">
        ...
        <UCard class="h-full transition-all duration-300 hover:shadow-lg hover:-translate-y-1">
          <div class="flex flex-col h-full text-center">
            <div
              class="w-16 h-16 flex items-center justify-center mx-auto mb-4 rounded-2xl bg-primary-50 dark:bg-primary-900/20">
              <UIcon name="i-ph-code-bold" size="2.5rem" class="text-primary-600 dark:text-primary-400" />
            </div>
            <h3>Technical Excellence</h3>
            <p class="text-sm text-neutral-600 dark:text-neutral-400 leading-relaxed mb-6">
              Deep technical expertise across full-stack development, DevOps,
        ...
        <UCard class="h-full transition-all duration-300 hover:shadow-lg hover:-translate-y-1">
          <div class="flex flex-col h-full text-center">
            <div
              class="w-16 h-16 flex items-center justify-center mx-auto mb-4 rounded-2xl bg-primary-50 dark:bg-primary-900/20">
              <UIcon name="i-ph-chart-line-up-bold" size="2.5rem" class="text-primary-600 dark:text-primary-400" />
            </div>
            <h3>Proven Results</h3>
            <p class="text-sm text-neutral-600 dark:text-neutral-400 leading-relaxed mb-6">
              Successful projects delivered with exceptional outcomes and
              measurable impact.
            </p>
            <div class="mt-auto pt-6 border-t border-neutral-200 dark:border-neutral-700">
              <div class="text-xl font-bold mb-1">
        ...
        <UCard class="h-full transition-all duration-300 hover:shadow-lg hover:-translate-y-1">
          <div class="flex flex-col h-full text-center">
            <div
              class="w-16 h-16 flex items-center justify-center mx-auto mb-4 rounded-2xl bg-primary-50 dark:bg-primary-900/20">
              <UIcon name="i-ph-handshake-bold" size="2.5rem" class="text-primary-600 dark:text-primary-400" />
            </div>
            <h3>True Partnership</h3>
            <p class="text-sm text-neutral-600 dark:text-neutral-400 leading-relaxed mb-6">
              I work closely with clients to understand unique needs, ensuring
              solutions that truly fit their business.
            </p>
            <div class="mt-auto pt-6 border-t border-neutral-200 dark:border-neutral-700">
              <div class="text-xl font-bold mb-1">
